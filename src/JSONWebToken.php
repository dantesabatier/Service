...
class JSONWebToken implements JsonSerializable
{
    ...
    public function __construct(public ?string $iss = null, public ?string $sub = null, public ?string $aud = null, public float $exp = PHP_FLOAT_MAX, public float $nbf = PHP_FLOAT_MAX, public float $iat = PHP_FLOAT_MAX, public ?string $jti = null, public mixed $dat = null)
    {
