 ...
 *
 * `$isComplete` answers the one question most callers have — is this an answer or not — and `$stopReason` says which ending produced it, because a provider failure, output limit, refusal, deadline, iteration cap, execution budget, context limit and write-approval boundary call for different corrections.
 *
