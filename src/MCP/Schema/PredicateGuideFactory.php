...
final readonly class PredicateGuideFactory
{
    public function make(): PredicateGuide
    {
        return new PredicateGuide(
            [
                ...
                "%s" => "String, boolean, enum value, or array (for IN and BETWEEN). For BETWEEN pass a two-element array: predicate=\"%K BETWEEN %s\", arguments=[\"creationDate\", [\"2025-01-01\", \"2025-01-31\"]]",
                "%d" => "Integer",
                "%f" => "Float",
            ],
            [
    ...
    {
        return [
            'Equality: predicate="%K = %s", arguments=["status", "active"]',
