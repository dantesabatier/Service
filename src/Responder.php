    ...
    public Response $response {
        get {
            try {
                ...
                // Read in this order deliberately: producing the body is what runs the action, and a responder may build part of its transformer context from what the action left behind — MCPResponder carries the session identifier its handshake issued. Passing both inline would evaluate the context first, since PHP reads arguments left to right, handing the pipeline a context assembled before the work it describes had happened.
                $data = $this->data;
