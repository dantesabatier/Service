...
{
    /** @var Response the `Response` generated by this strategy for the associated `Responder`. */
    abstract public Response $response {
        get;
    }

    /**
     * @param Responder $responder The `Responder` instance that this strategy operates on.
     */
